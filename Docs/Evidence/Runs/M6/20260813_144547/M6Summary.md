# GAS M6 verification: 20260813_144547

- Result: **PASS**
- Per-direction lag: 150 ms
- Approximate RTT: 300 ms
- Per-direction loss: 5%
...
| Host loss injection was applied | PASS | PktLoss=5 |
| Client loss injection was applied | PASS | PktLoss=5 |
...
| Client event order is valid | PASS | 144101 < 144363 < 146432 < 148799 < 150547 < 150858 < 152923 < 154828 < 155440 < 155751 |
| Host event order is valid | PASS | 145923 < 146287 < 147556 |
...
| Immunity Cue Removed callbacks are ordered by transaction | PASS | 148337 < Reject=148799; 156050 > RecoveryCheckpoint=155440 |
